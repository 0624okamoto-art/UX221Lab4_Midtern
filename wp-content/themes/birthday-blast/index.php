        ...
        <div class="col-lg-8 col-md-8 col-12">
          ...
          <?php endwhile; ?>
            <?php the_posts_pagination( array(
              'prev_text' => __( 'Previous page', 'birthday-blast' ),
              'next_text' => __( 'Next page', 'birthday-blast' ),
              'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'birthday-blast' ) . ' </span>',
            ) ); ?>
          <?php else : ?>
